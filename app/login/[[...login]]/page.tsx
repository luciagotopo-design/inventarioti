...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex overflow-hidden relative">
      ...
      <div className="flex w-full items-center justify-between px-8 lg:px-16 relative z-10">
        ...
        <div className="flex-1 hidden lg:flex flex-col justify-center pr-16">
          ...
          <p className="text-xl text-blue-200 mb-8 max-w-lg leading-relaxed">
            Gestión profesional y control total de tu infraestructura tecnológica
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-slate-300 group hover:text-white transition-colors">
              ...
              <span className="font-medium">Control de equipos críticos</span>
            </div>
            <div className="flex items-center gap-3 text-slate-300 group hover:text-white transition-colors">
              <div className="w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center group-hover:bg-blue-500/30 transition-colors">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="font-medium">Reportes inteligentes</span>
            </div>
            <div className="flex items-center gap-3 text-slate-300 group hover:text-white transition-colors">
              <div className="w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center group-hover:bg-blue-500/30 transition-colors">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="font-medium">Plan de mantenimiento</span>
            </div>
          </div>
        </div>
