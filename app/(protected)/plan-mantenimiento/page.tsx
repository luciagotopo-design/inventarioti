...
import { ImageIcon, Video, X, Eye } from 'lucide-react';
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p><strong>Completitud:</strong> {analysisResult.evaluacion_plan?.completitud}</p>
                    <p><strong>Complejidad:</strong> {analysisResult.evaluacion_plan?.complejidad}</p>
                ...
                {planSeleccionado.costoReal && (
                  <div>
                    ...
                    <p className={`text-base font-medium ${
                      planSeleccionado.costoReal > (planSeleccionado.presupuesto || 0) ? 'text-red-600' : 'text-green-600'
                    }`}>
